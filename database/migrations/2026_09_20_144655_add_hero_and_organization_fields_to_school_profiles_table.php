    ...
    public function up(): void
    {
        Schema::table('school_profiles', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('school_profiles', 'school_image')) {
                $table->string('school_image')->nullable()->after('hero_description');
            }

            if (!Schema::hasColumn('school_profiles', 'organization_title')) {
                $table->string('organization_title')->nullable()->after('mission');
            }

            if (!Schema::hasColumn('school_profiles', 'organization_description')) {
                $table->text('organization_description')->nullable()->after('organization_title');
            }

            // organization_image sudah ada pada migration sebelumnya.
