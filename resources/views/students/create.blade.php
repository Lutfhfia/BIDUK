        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold text-dark mb-1">
                    <i class="bi bi-person-plus-fill text-success me-2"></i>Tambah Siswa Baru
                </h4>
                <p class="text-muted mb-0" style="font-size: 0.85rem;">
                    Lengkapi formulir berikut untuk menambahkan data siswa baru.
                </p>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nis" id="nis"
                                ...
                                placeholder="Contoh: 24001" required>
                            @error('nis')
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nisn" id="nisn"
                                ...
                                placeholder="Contoh: 0101010101" required>
                            @error('nisn')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="nickname" id="nickname"
                                class="form-control @error('nickname') is-invalid @enderror" value="{{ old('nickname') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="religion" id="religion"
                                ...
                                @foreach (['Islam', 'Kristen', 'Katolik', 'Hindu', 'Buddha', 'Konghucu'] as $agama)
                                    <option value="{{ $agama }}"
                                        {{ old('religion') == $agama ? 'selected' : '' }}>{{ $agama }}</option>
                                @endforeach
                            </select>
                            @error('religion')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="kk_number" id="kk_number"
                                ...
                                value="{{ old('kk_number') }}" placeholder="Nomor KK">
                            @error('kk_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="certificate_date_number" id="certificate_date_number"
                                ...
                                value="{{ old('certificate_date_number') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="transfer_from_school" id="transfer_from_school"
                                ...
                                value="{{ old('transfer_from_school') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="transfer_accepted_date" id="transfer_accepted_date"
                                ...
                                value="{{ old('transfer_accepted_date') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="transfer_letter_number" id="transfer_letter_number"
                                ...
                                value="{{ old('transfer_letter_number') }}">
